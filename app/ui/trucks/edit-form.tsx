...
import { TruckForm } from '@/app/lib/trucks.definitions';
...
export default function EditTruckForm({
  ...
  const updateTruckWithId = updateTruck.bind(null, truck.id);
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={truck.customer_id}
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={truck.status === 'pending'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="paid"
                  defaultChecked={truck.status === 'paid'}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="paid"
